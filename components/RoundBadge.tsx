...
const colours: Record<string, string> = {
  ...
  round_of_32:   'bg-purple-100 text-purple-800',
  round_of_16:   'bg-purple-100 text-purple-800',
  quarter_final: 'bg-orange-100 text-orange-800',
  semi_final:    'bg-red-100 text-red-800',
  third_place:   'bg-yellow-100 text-yellow-800',
